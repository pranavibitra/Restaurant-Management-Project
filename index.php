...
<html>
<head>
	<title><center>Aura Cafe</center></title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">Aura Cafe</a>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="jumbotron">
  <h1 class="display-4">Welcome to Aura Cafe</h1>
  <p class="lead">Kakinada's most popular Cafe</p>
    <p> 5 Star Service</p>
    <hr class="my-4">  
